...
import { randomizeArray, displayNb, limitDecimals, getValuePercentInRange } from '$lib/generic_utils';
import { getSelectedItemSetting } from '$lib/ecometrics/selection';
