...
<div class="rich-text">
	<p>
		This page currently shows the last 30 entries indexed. The full dataset contains { displayNb(searchIndexPreviewData.total) } entries. You can load a local copy of the database to browse and filter all entries :
	</p>
